...
namespace llvm {
    ...
    struct SafecodeVarMap : public FunctionPass {
        static char ID;
       ...
       // virtual bool runOnModule(Module &M);
		...
		std::pair< std::string , ranges::Range> getRangePair(ACSLExpression *expr);
		
        std::string findNameIRRigel(StringMap< std::vector<VarMappingInfo> > * mappingMap, MDNode *  annotationContext,BasicBlock * basicBlock, std::string  nameSC, int codeLine);
